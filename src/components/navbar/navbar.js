        ...
        <>
          ...
          <div className="header-item">
            <details className="header-dropdown" id="profile">
              <summary className="btn btn-default px-7 header-button"><span>{user.username}</span><i className="arrow"></i><div className="sml-photo mx-auto text-center">{this.props.auth.user.hasPhoto ? <img src={`https://storage.googleapis.com/schnitzel/avatar/${this.props.auth.user.id}/${this.props.auth.user.id}${this.props.auth.user.photoExt}`} className="card-img-top" /> : <img src="https://storage.googleapis.com/schnitzel/default.jpg" className="card-img-top" />}</div></summary>
